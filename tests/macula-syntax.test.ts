...
test('syntax assistance includes only approved NT and LXX reading surfaces', () => {
  ...
  assert.equal(syntaxAssistanceApplies('lxx', 'free-reading', '4-maccabees'), true)
  assert.equal(syntaxAssistanceApplies('lxx', 'free-reading', 'ezekiel'), true)
  assert.equal(syntaxAssistanceApplies('lxx', 'free-reading', 'exodus'), false)
  assert.equal(syntaxAssistanceApplies('lxx', 'free-reading', 'sirach'), false)
  assert.equal(syntaxAssistanceApplies('lxx', 'psalm', 'proverbs'), false)
